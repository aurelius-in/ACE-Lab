	...
	return (
		<div className="space-y-3">
			...
			<label className="block text-sm">
				...
				<select value={text.font || 'Poppins'} onChange={(e)=>setState({ text: { ...text, font: e.target.value } })} className="mt-1 w-full rounded-lg bg-black/30 border border-white/10 px-2 py-1">
